...
def main():
    ...
    train_loader = torch.utils.data.DataLoader(
        datasets.FashionMNIST('/home/enzo/data/F-MNIST', train=True, download=True,
    ...
    test_loader = torch.utils.data.DataLoader(
        datasets.FashionMNIST('/home/enzo/data/F-MNIST', train=False, transform=transforms.Compose([
                           transforms.ToTensor(),
                           transforms.Normalize((0.5,), (0.5,))
                       ])),
    ...
    for epoch in range(1, args.epochs + 1):
        tr_loss, tr_regu = train(args, model, device, train_loader, optimizer, epoch, mode = 0, gamma_mul=0.001, startlr = args.lr)
