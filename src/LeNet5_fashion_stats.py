...
def main():
    ...
    train_loader = torch.utils.data.DataLoader(
        datasets.FashionMNIST('/home/perlo/data', train=True, download=True,
    ...
    test_loader = torch.utils.data.DataLoader(
        datasets.FashionMNIST('/home/perlo/data', train=False, 
            transform=transforms.Compose([
                transforms.ToTensor(),
                transforms.Normalize((0.5,), (0.5,))
            ])),
    ...
    for i in range(args.n_seeds):
        ...
        if args.mode == 0:
            ...
            model.fc2 = nn.Sequential( nn.Dropout(p=0.5), model.fc2)
